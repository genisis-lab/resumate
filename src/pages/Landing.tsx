const FAQS = [
  ...
  ["Are AI features live?", "Local ATS analysis is live now. Online AI writing tools work only when an AI provider is configured; expanded hosted AI allowances and live parser testing are upcoming."],
