/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 96a8400875b1a8c2939fc330a4399231)
// Runtime types generated with workerd@1.20260811.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	APP_URL: "https://resume.builtwai.com";
	EMAIL_FROM: "ResuMate <verification@contact.builtwai.com>";
	WHOP_CHECKOUT_ENABLED: "false";
	WHOP_BUSINESS_ID: "biz_XNbFaV2vqlnbDu";
	WHOP_RESUMATE_PRODUCT_ID: "prod_ohtoVdNv8Bcr0";
	WHOP_RESUMATE_SPRINT_PLAN_ID: "plan_GxGtsMlfd53Xw";
	WHOP_RESUMATE_PRO_PLAN_ID: "plan_MEz1b5mn84LpV";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "EMAIL_FROM" | "WHOP_CHECKOUT_ENABLED" | "WHOP_BUSINESS_ID" | "WHOP_RESUMATE_PRODUCT_ID" | "WHOP_RESUMATE_SPRINT_PLAN_ID" | "WHOP_RESUMATE_PRO_PLAN_ID">> {}
}
