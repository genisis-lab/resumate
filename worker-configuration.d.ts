/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 01ba401aef9387e7a491fc4eb0b1e3ce)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "EMAIL_FROM">> {}
}
